...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark"  style="background-color: #0f6d79 !important">
            <a class="navbar-brand" href="{{route('home')}}">SPOT IT SONG</a>
        ...
        <script src="{{url('assets/dist/js/songs.js') }}"></script>
